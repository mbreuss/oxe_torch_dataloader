...
def make_pytorch_oxe_iterable_dataset(dataset: dl.DLataset, train=True, batch_size=512, transform_dict=None, num_workers=0, pin_memory=False, drop_last=False):
    return DataLoader(
